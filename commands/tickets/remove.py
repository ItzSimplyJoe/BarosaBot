...
async def removecmd(ctx, member : discord.Member):
    ...
    if ctx.channel.name.endswith("ticket"):
        ...
        embed = discord.Embed(title="Ticket", description=f"{member.mention} has been removed from the ticket", color=0x00ffff)
